...
question.querySelector( '#id_question_text' ).setAttribute("id","id_question_text_"+(counter+1));
question.querySelector( "#id_question_text_"+(counter+1) ).setAttribute("name","question_text_"+(counter+1));
question.querySelector( '.django-ckeditor-widget' ).setAttribute("data-field-id","id_question_text_"+(counter+1));
question.querySelector( '#id_question_optimal_answer' ).setAttribute("id","id_question_optimal_answer_"+(counter+1));
