...
var searchTypeBtn = document.querySelector("#searchType")
var advancedSearchSection = document.querySelector("#advancedSearch")
var basicSearchSection = document.querySelector("#basicSearch")

$(document).on('click', "#searchType", function() {
if (advancedSearchSection.style.display == 'none'){
searchTypeBtn.innerHTML = 'Basic Search';
advancedSearchSection.style.display = 'block';
basicSearchSection.style.display = 'none';
}
else{
searchTypeBtn.innerHTML = 'Advanced Search';
