...
var examStatusLabel =  document.querySelector( '.exam_status_label' );
var examStatusIcon =  document.querySelector( '.exam_status_icon' );
var exam_period =  document.querySelector( '.exam-period' );
if(language == "ar"){
$("h1","h5",".col-md-4").css('direction','rtl');
